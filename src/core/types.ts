...
// NOTE: the legacy continuity CheckpointReference / AnchorBatchPayload / EvidenceBundle types
// were removed (P4 + publish-hardening L-6) — they were unreachable after the continuity-evidence
// path was deleted. The canonical evidence types live in src/sep (SepBundle, SignedCheckpoint).
