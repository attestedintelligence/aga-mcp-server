...
calls should not be able to make one *vanish*. (Known issue 7 in the README lists the malformed tool calls 3.6.0
through 3.6.2 refuse without a receipt; this step tests the depth-bomb case, which does get one.) Drive the real proxy with a
