...
// legacy continuity bundle/checkpoint imports removed (P4)
...
describe('NCCoE Lab Demo - Full AGA Lifecycle', () => {
  ...
  it('Phase 2-4: Full lifecycle with receipts on every measurement', () => {
    ...
    // (legacy continuity checkpoint + evidence-bundle prove step removed in P4; the canonical SEP
    //  prove path is covered by the SEP conformance corpus + provable-denial regression.)
